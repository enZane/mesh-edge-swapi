...
import type { PokeapiTypes } from './sources/Pokeapi/types';
...
export type MeshContext = PokeapiTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".mesh/sources/Pokeapi/introspectionSchema":
      return import("./sources/Pokeapi/introspectionSchema") as T;
...
const pokeapiTransforms = [];
const additionalTypeDefs = [] as any[];
const pokeapiHandler = new GraphqlHandler({
              name: "Pokeapi",
              config: {"endpoint":"https://swapi-graphql.netlify.app/.netlify/functions/index"},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("Pokeapi"),
              logger: logger.child("Pokeapi"),
              importFn,
            });
sources[0] = {
          name: 'Pokeapi',
          handler: pokeapiHandler,
          transforms: pokeapiTransforms
        }
